$(document).ready(function() {
    ...
    $('.amenities_bg ul li').slice(0, 10).show();
    if ($('.amenities_bg ul li:hidden').lenght != 0) {
    ...
    $('.view_more').on('click', function(e) {
        e.preventDefault();
        $('.amenities_bg ul li:hidden').slice(0, 50).slideDown();
    ...
    $('.less_more').on('click', function(e) {
        e.preventDefault();
        $('.amenities_bg ul li').slice(10, 50).slideUp();
        $('.view_more').addClass('view_more_add');
